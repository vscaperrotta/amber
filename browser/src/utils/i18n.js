const translations = {
	en: {
		...
		'options.signInTab': 'Sign in',
		'options.registerTab': 'Register',
		'options.username': 'Username',
		'options.register': 'Create account',
		'options.forgotPassword': 'Forgot password?',
		'options.resetPasswordTitle': 'Reset password',
		'options.resetPasswordDesc': 'Enter your email and we\'ll send you a reset link.',
		'options.sendResetLink': 'Send reset link',
		'options.resetLinkSent': 'Reset link sent. Check your inbox.',
		'options.backToSignIn': 'Back to sign in',
	...
	it: {
		...
		'options.signInTab': 'Accedi',
		'options.registerTab': 'Registrati',
		'options.username': 'Nome utente',
		'options.register': 'Crea account',
		'options.forgotPassword': 'Password dimenticata?',
		'options.resetPasswordTitle': 'Reimposta password',
		'options.resetPasswordDesc': 'Inserisci la tua email e ti invieremo un link per reimpostarla.',
		'options.sendResetLink': 'Invia link di reset',
		'options.resetLinkSent': 'Link di reset inviato. Controlla la tua posta.',
		'options.backToSignIn': 'Torna al login',
